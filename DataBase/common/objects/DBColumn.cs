...
namespace DataBase.common.objects
{
    public class DBColumn
    {
        ...
        internal DBColumn(string id, Type field, KeyType key, bool nullable, object def)
        {
            ID = id.Trim().ToUpper();
            DataType = field;
            KeyType = key;
        ...
        {
            return new DBColumn(this.ID, this.DataType, this.KeyType, this.Nullable, this.DefaultValue)
            {
