    ...
    internal class DBForeign : IDisposable
    {
        ...
        public List<DbCommand> GetDeleteCommands(DatabaseCore accessor)
        {
            ...
            if (accessor != null && Mode == ForeignMode.Correlative && Value != null)
            {
                ...
                {
                    case 1: //Entity
                        commands.AddRange(((TableEntity)Value).GetDeleteCommands(accessor));
                        break;
                    case 2: //List
        ...
        public List<DbCommand> GetSaveCommands(DatabaseCore accessor)
        {
            ...
            if (accessor != null && Mode == ForeignMode.Correlative && Value != null)
            {
                ...
                {
                    case 1: //Entity
                        commands.AddRange(((TableEntity)Value).GetSaveCommands(accessor));
                        break;
                    case 2: //List
                        ...
                        lst_del.ForEach(itm =>
                        {
                            commands.AddRange(itm.GetDeleteCommands(accessor));
                        });
                        lst_new.ForEach(itm =>
                        {
                            commands.AddRange(itm.GetSaveCommands(accessor));
                        });
